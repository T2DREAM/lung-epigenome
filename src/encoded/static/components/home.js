	...
	const { context } = this.props;
		...
		<br/>
		       ...
		       <div className="site-banner-search">
                                     ...
                                     <div>
                                     <h4 className="search-header">Query Accessible Chromatin</h4>
                                     <span>
		                     <a className="btn-lg btn-tools" target = "_blank" href = { 'http://www.tools.complexdiseaseepigenome.org/cellBrowser/?ds=lungsnatacseq' } style= {{ 'font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box',  'justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif', 'margin-top': '5px'}} title="Interactive ATAC-seq single-cell expression viewer">Single Cell UMAP</a>
		                     <a className="btn-lg btn-tools" target = "_blank" href = { 'https://www.tools.lungepigenome.org/igv-webapp/' } style= {{'margin-left': '5px', 'font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box', 'justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px'}}>Genome Browser</a>
		                     <a className="btn-lg btn-tools" target = "_blank" href = { 'https://www.lungepigenome.org/search/?searchTerm=ATAC' } style= {{'margin-left': '5px', 'font-size':'17px', 'word-break': 'break-word', 'display': '-webkit-inline-box','justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px' }}>snATAC-seq Datasets</a>
<a className="btn-lg btn-tools" target = "_blank" href = { 'https://www.crocpot.org/lung' } style= {{'margin-left': '5px', 'font-size':'17px', 'word-break': 'break-word', 'display': '-webkit-inline-box','justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px' }}>Predict Target Genes</a>
                                     </span>
                                     </div>
                                    
                                     <div>
                                     <span>
                                     <h4 className="search-header">Query Gene Expression:</h4>
		                     <a className="btn-lg btn-tools" target = "_blank" href = { 'http://www.tools.complexdiseaseepigenome.org/cellBrowser/?ds=lungsnrnaseq' } style= {{ 'font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box', 'justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px'}}>Single Cell UMAP</a>
		                     <a className="btn-lg btn-tools" target = "_blank" href = { 'http://www.tools.lungepigenome.org:3838/RShiny/' } style= {{ 'margin-left': '5px','font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box', 'justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px'}}>Expression Profiles</a>		            <a className="btn-lg btn-tools" target = "_blank" href = { 'https://www.lungepigenome.org/search/?searchTerm=RNA-seq&type=Experiment' } style= {{'margin-left': '5px', 'font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box','justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif','margin-top': '5px'}}>snRNA-seq Datasets</a>
                                     </span>
                                     </div>
		       </div>
                    </div>
